...
test('Safeguard against content-type spoofing - string', async t => {
  ...
  fastify.addContentTypeParser('text/plain1', function (request, body, done) {
    t.pass('should be called')
    done(null, body)
  })
  fastify.addContentTypeParser('application/json1', function (request, body, done) {
  ...
  await fastify.inject({
    ...
    path: '/',
    headers: {
      'content-type': 'text/plain1; content-type="application/json1"'
    },
    body: ''
  })
})
